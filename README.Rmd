...
Currently, this package provides several functions related to equivalency tests.
Factors for a two-sample dual-acceptance criteria can be calculated as follows:
...
The power of this test for detecting reduction in mean can be computed as
follows:

```{r power_sim_dual_example}
power_sim_dual(
  n_qual = 18,
  m_equiv = 6,
  replicates = 2500,
