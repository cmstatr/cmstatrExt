// This file based on doctest.h. See original copyright statement below.
// This file originally licensed under MIT.
// The following changes have been made by Stefan Kloppenborg:
// - Comment out MESSAGE and WARN macros as they conflict with macros in Rcpp
// - Replace std::cout with Rcpp::Rcout
// - Replace std::cerr with Rcpp::Rcerr
// - Include Rcpp
// - Remove option for random ordering of tests
// - Remove std::abort control path from failed_out_of_a_testing_context
//   because R cmd check complains about abort() being in the code
...
{
    std::ostream* cout;        // stdout stream - Rcpp::Rcout by default
    std::ostream* cerr;        // stderr stream - Rcpp::Rcerr by default
...
namespace {
    ...
    DOCTEST_NORETURN void throw_exception(Ex const& e) {
        ...
        throw e;
#else  // DOCTEST_CONFIG_NO_EXCEPTIONS
        Rcpp::Rcerr << "doctest will terminate because it needed to throw an exception.\n"
...
// =================================================================================================
    ...
    public:
        ...
        XmlWriter( std::ostream& os = Rcpp::Rcout );
        ~XmlWriter();
