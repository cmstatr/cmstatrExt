...
//#include "config.h" /* includes config.h, math.h */
#include <math.h>
#include <cmath>
#include "dpq.h"
...
/* ----------------------------------------------------------------------- */
    ...
    *ierr = 0;
    ...
    eps = max(eps, 1e-15);
    a_lt_b = (a < b);  // moved declaration up a few lines to avoid error
...
/* ----------------------------------------------------------------------- */
	...
	if (b <= 1e3) {
	    n = (int)(a - 1.); // moved declaration of n up a few lines to avoid error
	    w = 1.;
	    for (int i = 1; i <= n; ++i) {
		a += -1.;
		double h = a / b;
